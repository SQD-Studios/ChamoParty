...
ChamoParty is a modernized fork of the zVoteParty plugin, rewritten with cleaner internals, modern Minecraft version support, and a proper API for developers. It is **not** a drop-in replacement — configs and class paths have changed — but it brings significant improvements over the original.
