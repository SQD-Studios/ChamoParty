package net.chamosmp.chamoparty.command;
...
public class CommandManager extends ZUtils implements CommandExecutor, TabCompleter {
	 ...
	 * @param template
	 */
	public CommandManager(ZVotePartyPlugin template) {
	...
	public void registerCommand(String string, VCommand vCommand, String... aliases) {
		/*try {
			...
			commandMap.register(command.getName(), this.plugin.getPluginMeta().getName(), command);
